  ...
  return (
    <div className="min-h-screen bg-brand-neutral-50 flex flex-col">
      ...
      <header className="relative">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-brand-neutral-900 via-brand-neutral-800 to-brand-neutral-900" />
        <div
        ...
        />
        <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-brand-primary-500 to-transparent opacity-60" />
        ...
        <div className="relative max-w-7xl mx-auto px-8 py-4 flex justify-between items-center">
          ...
          <button onClick={() => navigate("/inicio")} className="flex items-center gap-3 group">
            <div className="w-9 h-9 rounded-xl bg-brand-primary-500/20 border border-brand-primary-500/30 flex items-center justify-center">
            ...
            <div className="text-left">
              <h1 className="text-base font-semibold text-white leading-tight tracking-wide group-hover:text-brand-primary-300 transition-colors">
                GesClientes
              </h1>
              <p className="text-xs text-brand-primary-400 leading-tight">Portal empresarial</p>
            </div>
          </button>
          ...
          <div className="flex items-center gap-5">
            ...
            <button
              ...
              className="flex items-center gap-2 text-sm font-medium text-brand-neutral-400 hover:text-white transition-colors duration-200 group"
            >
              <svg className="w-5 h-5 group-hover:text-brand-primary-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="relative flex items-center justify-center w-9 h-9 rounded-xl bg-brand-primary-500/10 hover:bg-brand-primary-500/20 border border-brand-primary-500/20 hover:border-brand-primary-500/40 disabled:opacity-40 disabled:cursor-default transition-all duration-200 group"
              ...
              >
                <svg className="w-5 h-5 text-brand-neutral-400 group-hover:text-brand-primary-300 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                </svg>

                {/* Badge — reactivo a optimistic updates */}
                {totalItemsGlobal > 0 && (
                  <span className="absolute -top-1.5 -right-1.5 min-w-[18px] h-[18px] px-1 rounded-full bg-brand-primary-500 text-white text-[10px] font-bold flex items-center justify-center">
              ...
              {carritoOpen && empresasConItems.length > 1 && (
                <div
                  ...
                  style={{ background: "rgba(28,25,23,0.97)", backdropFilter: "blur(24px)" }}
                  role="listbox"
                    ...
                    return (
                      ...
                      >
                        <div className="text-left flex items-center gap-2.5">
                          ...
                          {esActual && (
                            <span className="w-1.5 h-1.5 rounded-full bg-brand-primary-400 shrink-0" />
                          )}
                          <div>
                            <p className={`text-sm font-semibold transition-colors ${esActual ? "text-brand-primary-300" : "text-white group-hover/item:text-brand-primary-300"}`}>
                              {(c as any).nombre_mercancia ?? `Empresa #${c.mercancia_id}`}
                              {esActual && (
                                <span className="ml-2 text-[10px] font-normal text-brand-primary-400/70">
                                  actual
                                </span>
                              )}
                            </p>
                            <p className="text-xs text-brand-neutral-400 mt-0.5 tabular-nums">
                        ...
                        <svg
                          className="w-4 h-4 text-brand-neutral-500 group-hover/item:text-brand-primary-400 transition-colors shrink-0"
            ...
            <div className="text-right hidden sm:block">
              ...
              <p className="text-xs text-brand-neutral-400">Cliente #{user?.cliente_id}</p>
            </div>
            ...
            >
              <div className="h-9 w-9 rounded-xl bg-brand-primary-500/20 border border-brand-primary-500/40 text-brand-primary-300 flex items-center justify-center font-semibold text-sm group-hover:bg-brand-primary-500/30 group-hover:border-brand-primary-500/60 transition-all duration-200">
                {initial}
              </div>
              <span className="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 bg-brand-primary-400 rounded-full border-2 border-brand-neutral-900" />
            </button>

            <div className="w-px h-6 bg-brand-neutral-700" />
            ...
            <button
              ...
              className="flex items-center gap-2 text-sm font-medium text-brand-neutral-400 hover:text-white transition-colors duration-200 group"
            >
              <svg className="w-4 h-4 group-hover:text-brand-primary-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
